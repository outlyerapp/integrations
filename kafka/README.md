...
|kafka_producer_producer-metrics_record-send-total                   |kafka.producer:type=producer-metrics, client-id=*/record-send-total                   |Gauge|       |            |The total number of records sent.                                                                                                                           |
...
|kafka_consumer_consumer-fetch-manager-metrics_records-consumed-total|kafka.consumer:type=consumer-fetch-manager-metrics, client-id=*/records-consumed-total|Gauge|       |            |The total number of records consumed.                                                                                                                       |
